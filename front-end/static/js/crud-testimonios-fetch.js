...
async function saveTestimonio(){
  ...
  // Crea un objeto con los datos de el testimonio
...
/**
 * Function que permite eliminar una testimonio del array del localstorage
 * de acuedo al indice del mismo
 * @param {number} id posición del array que se va a eliminar
 */
function deleteTestimonio(id){
  Swal.fire({
      estudiante: "Esta seguro de eliminar el testimonio?",
...
/**
 * Function que permite cargar el formulario con los datos de el testimonio 
 * para su edición
 * @param {number} id Id de el testimonio que se quiere editar
 */
